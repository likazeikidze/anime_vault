...
const Hero = () => {
  return (
    <div>
      <header className="bg-hero bg-center bg-cover bg-no-repeat py-16 px-8 sm:p-16 flex justify-center lg:items-center max-lg:flex-col w-full sm:gap-16 gap-0">
